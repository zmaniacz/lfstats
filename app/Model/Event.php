...
class Event extends AppModel
{
    ...
    public function getTeamStandings($state, $round = null)
    {
        ...
        foreach ($teams as $id => $name) {
            $standings[$id] = array('id' => $id, 'name' => $name, 'raw_points' => 0, 'points' => 0, 'adjustment' => null, 'played' => 0, 'won' => 0, 'lost' => 0, 'matches_played' => 0, 'matches_won' => 0, 'elims' => 0, 'for' => 0, 'against' => 0, 'ratio' => 0);
        }
