...
<div class="tab-content mt-4" id="myTabContent">
    <div class="tab-pane fade show active" id="solo-standings" role="tabpanel">
        <p>Total MVP is calculated as the total of a player's top 5 games by MVP at each position (10 for Scout) with
            the
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-sm nowrap" id="solo_standings">
                <thead>
                ...
                },
                {
                    data: function(row, type, val, meta) {
                        if (type === 'display' && loggedIn) {
                            return `<a class="float-left" data-bs-toggle="modal" data-event-player-id="${row.id}" 
