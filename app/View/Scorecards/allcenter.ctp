...
<div class="row">
    <div class="col-sm-6">
        Minimum Games: <span id="min_games_slider_value"></span><br /><br />
        <div id="min_games_slider"></div>
    </div>
    <div class="col-sm-6">
        Timeframe:<br /><br />
        <select class="custom-select" id="min_days_select">
...
<div class="row mt-4">
    <div class="col-sm-6">
        ...
        <table class="allcenter table table-striped table-bordered table-hover table-sm" id="all_center_a">
            <thead>
                <th>Position</th>
                <th>Player</th>
                <th>Average MVP</th>
    ...
    <div class="col-sm-6">
        ...
        <table class="allcenter table table-striped table-bordered table-hover table-sm" id="all_center_b">
            <thead>
                <th>Position</th>
                <th>Player</th>
                <th>Average MVP</th>
...
$(document).ready(function() {
    ...
    if ($("#min_games_slider").length) {
        ...
        min_games_slider.noUiSlider.on('update', function(values, handle, unencoded) {
            min_games = unencoded
            $("#min_games_slider_value").text(min_games)
