        ...
        function updateGameList(params) {
            $.ajax({
                ...
                response.data.forEach(function(element) {
                    ...
                    $gameLink.html('<strong>' + element.Game.game_name + ' - ' + element.Game.game_datetime +
                        '</strong>');
                    $heading.append($gameLink);

                    var red_team = '<span class="text-danger">Red Team: ' + (element.Game.red_score +
                            element.Game.red_adj) +
                        '</span>';
                    var green_team = '<span class="text-success">Green Team: ' + (element.Game.green_score +
