...
<table class="table table-bordered table-hover table-sm" id="avg_scores">
    <thead>
        <th>Win Type</th>
        <th>Green Score</th>
        <th>Red Score</th>
