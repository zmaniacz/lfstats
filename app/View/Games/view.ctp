...
<h4 class="text-center"><small><a href="https://lfstats-next.vercel.app/replay/<?php echo str_replace('.tdf', '', $game['Game']['tdf_key']); ?>" target="_blank" rel="noopener noreferrer">Replay Beta</a></small>
</h4>
...
<div class="tab-content" id="gameViewContent">
    ...
    <div class="tab-pane fade" id="actions-tab-content">
        ...
        <div id="gameActionsContainer">
            ...
            <table id="game-log-table" class="table table-bordered table-hover table-sm text-nowrap" style="width: 100%">
                <thead>
                    <tr>
                        <th>Time</th>
                        <th>Action</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        function renderGameScoreChart(scoreData, actionData) {
            let teams = [];
            teams = scoreData.GameTeam.GameTeam.filter(team => {
