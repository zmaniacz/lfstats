...
foreach ($types as $type) {
    ...
    foreach (${$type}[0]['Scorecard'] as $key => $val) {
        ${$type."_acc_plot"}[] = ((float)$val['shots_hit']/(float)$val['shots_fired'])*100;
...
<div class="tab-content" id="tabs">
	...
	<div role="tabpanel" class="tab-pane" id="overall_tab">
		...
		<br />
		<br />
		<p>The following graphs represent a simple rolling average for accuracy, score and MVP points both overall and by
			position.<br />
			Individual lines can be turned on and off by clicking on the title in the legend.<br />
			Clicking the legend items marked scatter will show all the points on the graph for the data set, if you like that
			sort of thing.<br />
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<div id="headPlayerPosSelector" class="btn-group lf-positions" data-toggle="buttons">
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_player_pos_options" value="commander" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-commander"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_player_pos_options" value="heavy" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-heavy"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_player_pos_options" value="scout" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-scout"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_player_pos_options" value="ammo" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-ammo"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_player_pos_options" value="medic" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-medic"></span>
					</label>
				</div>
			</div>
			<div class="col-sm-4">
				...
				<div id="headTargetPosSelector" class="btn-group lf-positions" data-toggle="buttons">
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_target_pos_options" value="commander" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-commander"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_target_pos_options" value="heavy" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-heavy"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_target_pos_options" value="scout" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-scout"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_target_pos_options" value="ammo" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-ammo"></span>
					</label>
					<label class="btn btn-primary active">
						<input type="checkbox" name="head_target_pos_options" value="medic" autocomplete="off" checked><span style="font-size:32px"
						 class="icon-medic"></span>
					</label>
				</div>
			</div>
