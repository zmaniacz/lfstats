<div id="penalty_edit" class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <br />
        <?= $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Penalty.id')), array('class' => 'btn btn-danger'), __('Are you sure you want to delete # %s?', $this->Form->value('Penalty.id'))); ?>
        </li>
    </div>
</div>