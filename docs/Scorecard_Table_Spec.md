...
| Column     | Type    | Null  | Source      | Description                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------- | ------- | ----- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `score`    | integer | never | line type 6 | Final score at game end, **before** any penalty deduction. Matches the `new` value of this player's last line type 5 score entry, plus the value of every in-game `0600` penalty assessed against them — the TDF bakes those deductions into the score stream, but the database applies them separately through `GamePenalty.score_value` so they can be edited or rescinded. See [Core_Schema.md](Core_Schema.md#gamepenalty). |
