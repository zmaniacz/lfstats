...
function getSortValue(
  ...
  switch (col) {
    ...
    case "avgLifeBoost":
      return item.avgLifeBoost ?? -Infinity;
...
export function MedicPlayersTable({
  players,
}: {
  players: CompetitionMedicPlayer[];
}) {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <SortableHead
                  column="avgDoubleResuppliesGiven"
                  sort={sort}
                  onSort={handleSort}
                >
                  Avg Doubles
              ...
              {pageRows.map((p) => {
                ...
                return (
                  <TableRow key={p.playerId}>
                    ...
                    <TableCell className="tabular-nums">
                      {p.avgLifeBoost !== null
                        ? p.avgLifeBoost.toFixed(2)
                        : "—"}
                    </TableCell>
                    <TableCell className="tabular-nums">
                      {p.avgResuppliesGiven !== null
                        ? p.avgResuppliesGiven.toFixed(2)
                        : "—"}
                    </TableCell>
                    <TableCell className="tabular-nums">
