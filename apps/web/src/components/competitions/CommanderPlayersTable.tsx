...
function getSortValue(item: CompetitionCommanderPlayer, col: SortColumn): string | number {
  switch (col) {
    ...
    case "nukeSuccessRatio":
      return item.nukeSuccessRatio ?? -Infinity;
    case "avgNukeLength":
      return item.avgNukeLength ?? -Infinity;
    case "avgNukeEfficiency":
      return item.avgNukeEfficiency ?? -Infinity;
  }
}
