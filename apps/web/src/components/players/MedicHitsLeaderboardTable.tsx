...
export function MedicHitsLeaderboardTable({ players }: { players: PlayerMedicHitsItem[] }) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Medic Hits</CardTitle>
      </CardHeader>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <SortableHead column="totalMedicHitsNonResup" sort={sort} onSort={handleSort}>
                Total Medic Hits (Non-Resup)
              </SortableHead>
              <SortableHead column="avgMedicHitsNonResup" sort={sort} onSort={handleSort}>
                Avg Medic Hits (Non-Resup)
              </SortableHead>
